...
N_o = 1539538; %number of orifices in droplet manifold 

%Input operating conditions 
Q = 5.77E-01; %liquid flowrate (m3/s)
T = 30+273.15; %liquid temperature (K)
P = 3.9; %operating (headspace) pressure (atm)  

%Input relavelt gas composition information 
DAB = 2.01E-9; %diffusion coefficient of gas in water at correct Temp (m2/s)
H = (1/(exp(-171.2542+8391.24/T+23.24323*log(T)-0*T)))/55342; %Henry's Constant for gas (atm-m3/mol)
c0 = 0; %initial dissolved gas concentration (g/L)
mass_Gas = 32; %relavent gas molar mass (g/mol)
